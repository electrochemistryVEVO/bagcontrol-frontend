    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: '1 1 120px' }}>
          <label style={{ fontSize: 11, fontWeight: 600, color: '#64748b', textTransform: 'uppercase' as const, letterSpacing: '0.05em' }}>Origen</label>
          <input
            value={filtroOrigen}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: '1 1 120px' }}>
          <label style={{ fontSize: 11, fontWeight: 600, color: '#64748b', textTransform: 'uppercase' as const, letterSpacing: '0.05em' }}>Destino</label>
          <input
            value={filtroDestino}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: '1 1 120px' }}>
          <label style={{ fontSize: 11, fontWeight: 600, color: '#64748b', textTransform: 'uppercase' as const, letterSpacing: '0.05em' }}>Cliente</label>
          <input
            value={filtroCliente}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: '2 1 200px' }}>
          <label style={{ fontSize: 11, fontWeight: 600, color: '#64748b', textTransform: 'uppercase' as const, letterSpacing: '0.05em' }}>Buscar código</label>
          <input
          ...
          {hayFiltros && (
            <button
              ...
              style={{
                ...
                background: '#fff', color: '#64748b', fontSize: 13, cursor: 'pointer', whiteSpace: 'nowrap',
              }}
            >
              Limpiar
            </button>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' as const, fontSize: 13 }}>
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={6} style={{ padding: 40, textAlign: 'center' as const, color: '#94a3b8' }}>
